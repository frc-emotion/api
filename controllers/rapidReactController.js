...
const getGames = asyncHandler(async (req, res) => {
    ...
    const games = req.params.id
        ? // find game by id if id provided
          await Game.findById(req.params.id)
        : req.query.competition
        ? // find game by competition if queried
          await Game.find({ competition: req.query.competition })
        : // otherwise show all games for the season
          await Game.find({});
